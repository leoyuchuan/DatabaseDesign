...
(
	...
	CONSTRAINT fk_student_2 FOREIGN KEY (track_name) REFERENCES TRACK(name)     This Constraint will add later on*/
);
...
(
	...
	CONSTRAINT fk_department FOREIGN KEY (head_prof_net_id) REFERENCES PROFESSOR(net_id)          This constaint will added later*/
);
...
(
	...
	CONSTRAINT fk_classroom FOREIGN KEY (building_abbreviation,room_number) REFERENCES ROOM(building_abbreviation,room_number)
);
...
(
	...
	CONSTRAINT chk_ta_office_number CHECK (office_roomnumber>=1000 AND office_roomnumber<=9999),
...
(
	...
	CONSTRAINT fk_lecturer_1 FOREIGN KEY (office_roomnumber,office_building_abbreviation) REFERENCES OFFICE(room_number,building_abbreviation),
...
(
	...
	CONSTRAINT fk_instructor FOREIGN KEY 			use trigger later*/
);
...
(
	...
	CONSTRAINT chk_course_coursenumber CHECK (course_number>=1000 AND course_number<=9999),
...
(
	...
	CONSTRAINT chk_section_sectionnumber CHECK (section_number>=0 AND section_number<=999),
...
(
	...
	CONSTRAINT fk_run_2 FOREIGN KEY (building_abbreviation,room_number) REFERENCES LAB(building_abbreviation,room_number)
);
...
ALTER TABLE DEPARTMENT ADD CONSTRAINT fk_department FOREIGN KEY (head_prof_net_id) REFERENCES PROFESSOR(net_id);
ALTER TABLE STUDENT ADD CONSTRAINT fk_student_2 FOREIGN KEY (track_name) REFERENCES TRACK(name);
